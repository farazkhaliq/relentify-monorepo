...
image: "/blog/account-government-grants-subsidies.jpg"
imageAlt: "Business owner reviewing grant funding documentation and accounting records"
tags: ["accounting for grants", "government grant bookkeeping"]
region: "all"
---
...
|---------|-------|--------|
| Bank account | 24,000 | |
| Deferred grant income (liability) | | 24,000 |
...
| Account | Debit | Credit |
|---------|-------|--------|
| Deferred grant income (liability) | 1,000 | |
| Grant income (revenue) | | 1,000 |
...
Use your [accounting software's](/accounting) tagging or project tracking features to assign grant-related transactions to the specific grant. This lets you:
...
Relentify's [accounting platform](/accounting) supports project-level tracking and reporting, making it straightforward to manage grant expenditure alongside your normal business accounting and produce the reports that grantors require.
