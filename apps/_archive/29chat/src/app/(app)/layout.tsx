...
import { Settings, MessageSquare, Ticket, BookOpen, BarChart3 } from 'lucide-react';
import {
  NavShell,
  TopBar,
  TopBarLink,
...
export default async function AppLayout({ children }: { children: React.ReactNode }) {
  ...
  if (!user) redirect('https://auth.relentify.com/login?redirect=https://chat.relentify.com/inbox');
