...
export default async function SharedAppLayout({ children }: { children: React.ReactNode }) {
  ...
  // Build nav links based on product
  const coreLinks = (
    <>
  ...
  // Connect features (available in connect + crm)
