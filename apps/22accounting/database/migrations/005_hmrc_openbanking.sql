...
-- VAT on acc_bills (input VAT for Box 4/7)
ALTER TABLE acc_bills ADD COLUMN IF NOT EXISTS vat_rate NUMERIC(5,2) NOT NULL DEFAULT 0;
ALTER TABLE acc_bills ADD COLUMN IF NOT EXISTS vat_amount NUMERIC(12,2) NOT NULL DEFAULT 0;
...
CREATE INDEX IF NOT EXISTS idx_bank_connections_user ON acc_bank_connections(user_id);
