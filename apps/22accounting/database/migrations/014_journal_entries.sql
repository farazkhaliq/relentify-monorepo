...
CREATE INDEX IF NOT EXISTS idx_je_entity_date  ON acc_journal_entries(entity_id, entry_date);
CREATE INDEX IF NOT EXISTS idx_je_source       ON acc_journal_entries(source_type, source_id);
...
CREATE INDEX IF NOT EXISTS idx_jl_account ON acc_journal_lines(account_id);
