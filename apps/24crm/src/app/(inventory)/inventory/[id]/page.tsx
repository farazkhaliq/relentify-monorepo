...
import { toInventory, toPhoto, InventoryWithPhotos } from '@/lib/services/inventory/types'
import { getAuthUser } from '@/lib/services/inventory/auth'
import { notFound, redirect } from 'next/navigation'
import Link from 'next/link'
import PhotoManager from '@/components/inventory/PhotoManager'
import CopyConfirmLink from '@/components/inventory/CopyConfirmLink'
